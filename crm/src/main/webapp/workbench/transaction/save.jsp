    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#search-activity").keydown(function (event) {
                if (event.keyCode == 13) {
                    $.ajax({
                        ...
                        data: {
                            "activityName": $.trim($("#search-activity").val()),
                        },
                        type: "get",
                        dataType: "json",
            ...
            $("#search-contacts").keydown(function (event) {
                if (event.keyCode == 13) {
                    $.ajax({
                        ...
                        data: {
                            "contactsName": $.trim($("#search-contacts").val()),
                        },
                        type: "get",
                        dataType: "json",
                        success: function (data) {
            ...
            $("#selectBtn2").click(function () {
                var $check = $("input[name=contacts]:checked");
                var id = $check.val();
                var name = $("#" + id).html();
                    ...
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="width: 300px;"
                                   placeholder="请输入市场活动名称，支持模糊查询" id="search-activity">
...
<div class="modal fade" id="findContacts" role="dialog">
    <div class="modal-dialog" role="document" style="width: 80%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" id="selectBtn2">选择</button>
            </div>
        </div>
    </div>
</div>
...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;" action="workbench/transaction/save.do" id="tranForm">
    ...
    <div class="form-group">
        <label for="create-customerName" class="col-sm-2 control-label">客户名称<span
                style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-customerName" name="customerId" placeholder="支持自动补全，输入客户不存在则新建">
        </div>
    ...
    <div class="form-group">
        ...
        <label for="create-activity" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);"
                                                                                           data-toggle="modal"
    ...
    <div class="form-group">
        <label for="create-contacts" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);"
                                                                                            data-toggle="modal"
